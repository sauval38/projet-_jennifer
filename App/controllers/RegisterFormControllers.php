...
class RegisterFormControllers {
    ...
    private function sendVerificationEmail($email, $token) {
        ...
        try {
            ...
            $mail->Body    = "Cliquez sur ce lien pour vérifier votre email : <a href='http://localhost/Projet-stage/projet-_jennifer/?action=verify&token=$token'>Confirmer votre email</a>";
            $mail->AltBody = "Cliquez sur ce lien pour vérifier votre email : http://localhost/Projet-stage/projet-_jennifer/?action=verify&token=$token"; // Version texte
