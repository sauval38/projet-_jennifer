...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 23 oct. 2024 à 13:06
...
INSERT INTO `about_me` (`id`, `image_path`, `bio`, `text_1`, `text_2`, `text_3`, `created_at`, `updated_at`) VALUES
(1, 'assets/images/aboutMe/a-propos-de-moi.jpg', 'En véritable passionnée de la nature, je suis une enfant de la Terre. Depuis ma plus tendre enfance, j\'aime travailler les matières, jouer avec elles et laisser libre court à mon imagination pour donner vie à mes créations de toutes sortes.', 'Chaque pièce est réalisée à la main avec un souci du détail exceptionnel. Je mets en œuvre mon expertise pour créer des produits en céramique de qualité supérieure qui résistent à l\'épreuve du temps. Chaque article est conçu avec soin et précision pour vous offrir une expérience durable et satisfaisante. Optez pour la qualité et la beauté avec Maison Héméra.', 'Mes produits sont non seulement esthétiquement plaisants, mais ils vous aident également à garder vos pinceaux de maquillage, bijoux, produits à maquillage et fleurs bien organisés. Leur design fonctionnel permet de ranger vos précieux articles de beauté de manière pratique tout en ajoutant une touche de décoration à votre espace. ', 'Plongez dans l\'univers du boudoir avec notre Gamme Boudoir. Nos produits en céramique allient finesse et sophistication, apportant une touche d\'élégance intemporelle à votre espace de beauté. Chaque pièce est minutieusement conçue pour refléter la grâce et le charme du style boudoir, créant ainsi une ambiance luxueuse et raffinée.', '2024-10-10 14:03:26', '2024-10-20 19:52:19');
...
INSERT INTO `delivery` (`id`, `order_id`, `delivery_option_id`, `status`, `tracking_number`, `shipped_at`, `delivered_at`) VALUES
...
--
-- Structure de la table `general_stats`
--

CREATE TABLE `general_stats` (
  `product_made` int(11) NOT NULL DEFAULT 205,
  `product_sell` int(11) NOT NULL DEFAULT 500,
  `order_send` int(11) NOT NULL DEFAULT 394
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Déchargement des données de la table `general_stats`
--

INSERT INTO `general_stats` (`product_made`, `product_sell`, `order_send`) VALUES
(205, 500, 394);
...
INSERT INTO `home` (`id`, `image_path`, `informations`) VALUES
(1, 'assets/images/home/_GMA3126-min.jpg', 'caroussel_1'),
(2, 'assets/images/home/_GMA3089-min.jpg', 'caroussel_2'),
(3, 'assets/images/home/accueil_2.jpg', 'caroussel_3'),
(4, 'assets/images/home/_GMA3090-min.jpg', 'image_presentation'),
(5, 'assets/images/home/accueil_4.jpg', 'image_gamme'),
(6, 'assets/images/home/_GMA3182-min.jpg', 'produits_phares_1'),
(7, 'assets/images/home/DSC02815.jpg', 'produits_pahres_2'),
(8, 'assets/images/home/DSC02978.jpg', 'produits_phares_3');
...
INSERT INTO `order` (`id`, `user_id`, `payment_method_id`, `total_amount`, `order_date`, `status`) VALUES
(1, 5, 1, 549.99, '2024-10-23 12:25:03', '0');
...
INSERT INTO `order_detail` (`id`, `order_id`, `product_id`, `product_option_id`, `quantity`, `price`) VALUES
(1, 1, 3, 117, 4, 60.00),
(2, 1, 3, 119, 5, 60.00);
